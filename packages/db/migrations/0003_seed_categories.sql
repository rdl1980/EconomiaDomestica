...
with seed (slug, name, domain, parent_slug, icon, color, sort_order) as (
  values
    ...
    ('trasporti', 'Trasporti', 'trasporti', null, 'car', '#b45309', 370),
